      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">Four simple steps to accelerate career growth</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">{howItWorks.map((item,index)=>{
            return(
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center text-center space-y-4 max-w-3xl mx-auto">
            ...
            <p className="mx-auto max-w-[600px] md:text-xl text-primary-foreground/80">Join thousands of professionals who are advancing their careers with AI-powered guidance.</p>
            <Link href={'/dashboard'} passHref>
              <Button className={"h-11 mt-5 animate-bounce"} variant={"secondary"} size={"lg"}>
                Start Your Journey Today <ArrowRight className="ml h-4 w-4"/>
              </Button>
            </Link>
          </div>
        </div>
